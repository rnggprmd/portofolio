...
import { ArrowUpRight, Eye, X, CheckCircle2, Search, Image as ImageIcon, ChevronLeft, ChevronRight, FolderKanban } from 'lucide-react';
...
export default function ProjectsSection({ initialProjects = [] }) {
    ...
    const itemsPerPage = 4; // 2x2 grid layout per page
        ...
        <section id="projects" className="relative py-24 px-4 sm:px-8 bg-transparent border-y border-gray-200/80 dark:border-slate-800 transition-colors duration-300 overflow-hidden">
            <div className="max-w-6xl mx-auto space-y-12 relative z-10">
                ...
                {paginatedProjects.length > 0 ? (
                    ...
                    /* Empty State when no search or filter match */
                    <div className="py-16 text-center bg-white dark:bg-slate-900 rounded-3xl border border-dashed border-gray-200 dark:border-slate-800 p-8 space-y-4">
                        ...
                        <button
                            ...
                            className="px-4 py-2 rounded-full bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-xs font-semibold hover:bg-gray-800 dark:hover:bg-slate-100 transition cursor-pointer"
                        >
