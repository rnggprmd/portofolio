            ...
            <div className="space-y-8 max-w-4xl mx-auto">
                ...
                <div>
                    ...
                    <p className="text-xs sm:text-sm text-gray-500 dark:text-slate-400 font-sans mt-1">
                        Kelola seluruh informasi Hero Section, username GitHub, upload CV PDF, kontak, dan tautan sosial media
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <CardContent className="p-6 space-y-4">
                            <div className="space-y-2">
                                ...
                                {data.cv_url && data.cv_url !== '#' && (
                                    <div className="mt-2 p-3 rounded-2xl bg-gray-50 dark:bg-slate-950 border border-gray-200 dark:border-slate-800 flex items-center justify-between text-xs">
                                        <div className="flex items-center gap-2 font-mono text-gray-600 dark:text-slate-400">
                                            ...
                                            <span>File CV Saat Ini: <span className="font-bold text-gray-900 dark:text-white">{data.cv_url}</span></span>
                                        </div>
                                        <a href={data.cv_url} target="_blank" rel="noreferrer" className="text-xs font-semibold text-gray-900 dark:text-white underline hover:no-underline flex items-center gap-1">
                                            <span>Buka CV</span>
                    ...
                    <Card className="rounded-3xl bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 shadow-xs">
                        ...
                        <CardContent className="p-6 space-y-4">
                            <div className="space-y-1.5">
                                <Label htmlFor="avatar_file" className="text-xs font-semibold text-gray-700 dark:text-slate-300">Upload Foto Profil / Avatar Card (Format JPG, PNG, WEBP)</Label>
                                <Input
                                    id="avatar_file"
                                    type="file"
                                    accept="image/*"
